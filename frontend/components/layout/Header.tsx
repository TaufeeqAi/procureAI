...
/**
 * Full-width top bar spanning both the sidebar and content columns — this
 * matches the reference screenshot's shell structure (brand mark far left,
 * global search / notifications / session far right), which differs from
 * Phase 0's narrower per-column header. See AppShell for how the two
 * columns sit below this bar rather than beside it.
 */
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b border-border bg-sidebar px-4 md:px-5">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="hidden items-center gap-1.5 rounded-md bg-surface-raised px-2.5 py-1 text-xs font-medium text-ink-secondary lg:flex">
